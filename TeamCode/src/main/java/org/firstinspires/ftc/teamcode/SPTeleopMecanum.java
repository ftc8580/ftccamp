...
@TeleOp(name="SPTeleopMecanum", group="Linear Opmode")
public class SPTeleopMecanum extends LinearOpMode implements Runnable {
...
//    public CDDistanceSensor myDistanceSensor;
    ...
    public void runOpMode() {
        ...
        myHardware = new SPHardware(hardwareMap);
...
//            }
    ...
    public void run() {
        try {
            SPDriveChassis myChassis = new SPDriveChassis(myHardware);
